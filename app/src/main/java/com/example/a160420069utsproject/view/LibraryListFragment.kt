...
import com.example.a160420069utsproject.viewmodel.ListViewModel

class LibraryListFragment : Fragment() {
    private lateinit var viewModel: ListViewModel
    private val studentListAdapter = LibraryListAdapter(arrayListOf())
    ...
    fun observeViewModel() {
        viewModel.librarysLD.observe(viewLifecycleOwner, Observer {
